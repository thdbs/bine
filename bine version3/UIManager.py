...
def Render():
    ...
    DrawManager.UIGraphicList['hp_bar_back'].Draw(235 , 677 )
    DrawManager.UIGraphicList['hp_bar'].Draw(93 + MainState.jimmy.health/2, 680 , MainState.jimmy.health)
    DrawManager.UIGraphicList['shield_bar_back'].Draw(170, 658 )
    DrawManager.UIGraphicList['shield_bar'].Draw(78 + (MainState.jimmy.shield*3)/2, 660 , MainState.jimmy.shield*3)
    DrawManager.UIGraphicList['coin_bar'].Draw(81, 600)
